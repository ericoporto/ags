...
void Bitmap::SetSupportAlphaInColors(bool alpha_in_colors)
{
    _alphaInColors = alpha_in_colors;
}
...
void Bitmap::RotateBlt(const Bitmap *src, int dst_x, int dst_y, fixed_t angle)
{
