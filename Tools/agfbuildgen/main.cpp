...
// ok just to take some notes before I go to sleep
...
// regenerable
//
// NOTE2: it may probably default to think it's dir is the same as the other tools but also take a parameter so you can
// pass the dir where the ags Tools are.

// big issue is things like copy mv and the like are not standard across systems
// so they should be avoid at all costs in the builds
// ideally a small agsutils with little implementation of them as commands
