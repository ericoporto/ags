...
namespace AGS.Editor
{
    public partial class ScriptEditor : ScriptEditorBase, IScriptEditor
    {
        ...
        protected override void AddEditMenuCommands(MenuCommands commands)
        {
            ...
            commands.Commands.Add(new MenuCommand(COLLAPSE_ALL_REGIONS_COMMAND, "Collapse All Regions", Keys.Control | Keys.Shift | Keys.Subtract));
            commands.Commands.Add(new MenuCommand(EXPAND_ALL_REGIONS_COMMAND, "Expand All Regions", Keys.Control | Keys.Shift | Keys.Add));
            commands.Commands.Add(MenuCommand.Separator);
