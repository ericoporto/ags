...
namespace AGS.Editor
{
    public partial class frmMain : Form
    {
        ...
        private void LoadColorTheme(ColorTheme t)
        {
            ...
            t.SetColor("main-container/skin/auto-hide/tab-gradient/start", c => mainContainer.Skin.AutoHideStripSkin.TabGradient.StartColor = c);
            t.SetColor("main-container/skin/auto-hide/tab-gradient/end", c => mainContainer.Skin.AutoHideStripSkin.TabGradient.EndColor = c);
            t.SetColor("main-container/skin/auto-hide/tab-gradient/text", c => mainContainer.Skin.AutoHideStripSkin.TabGradient.TextColor = c);
            t.SetColor("main-container/skin/auto-hide/dock-strip-gradient/start", c => mainContainer.Skin.AutoHideStripSkin.DockStripGradient.StartColor = c);
            t.SetColor("main-container/skin/auto-hide/dock-strip-gradient/end", c => mainContainer.Skin.AutoHideStripSkin.DockStripGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/dock-strip-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.DockStripGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/dock-strip-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.DockStripGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/active-tab-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/active-tab-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/active-tab-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/inactive-tab-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/inactive-tab-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/document-gradient/inactive-tab-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-caption-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-caption-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-caption-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-caption-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-caption-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-caption-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-tab-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-tab-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/active-tab-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-tab-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-tab-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.EndColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/inactive-tab-gradient/text", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.TextColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/dock-strip-gradient/start", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.DockStripGradient.StartColor = c);
            t.SetColor("main-container/skin/dock-pane/tool-window/dock-strip-gradient/end", c => mainContainer.Skin.DockPaneStripSkin.ToolWindowGradient.DockStripGradient.EndColor = c);
