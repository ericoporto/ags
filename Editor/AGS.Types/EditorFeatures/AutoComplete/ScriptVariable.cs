...
namespace AGS.Types.AutoComplete
{
    ...
    {
        public ScriptVariable(string variableName, string type, bool isArray, bool isPointer, bool isStatic, bool isStaticOnly, bool noInherit, bool isProtected, int scriptCharacterIndex)
        {
