...
For now, the only way to get a compatible version is to use their Mercurial repository. For the reference, our build server is using revision ebcf0fe725: https://github.com/icculus/SDL_sound/archive/ebcf0fe725448f9dbaa7884114e0b96b9c041570.tar.gz
