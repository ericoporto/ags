...
ScreenOverlay *_display_main(int xx, int yy, int wii, const char *text, int disp_type, int usingfont,
                             int asspch, int isThought, TextShrink shrink_type, bool overlayPositionFixed, bool roomlayer = false);
void _display_at(int xx, int yy, int wii, const char *text, int disp_type, int asspch, int isThought, TextShrink allowShrink, bool overlayPositionFixed);
