...
public:
  ...
  virtual IDriverDependantBitmap* CreateDDBFromBitmap(const Bitmap *bitmap, bool opaque = false) = 0;
  ...
  virtual Texture *CreateTexture(const Bitmap *bmp, bool opaque = false) = 0;
