...
-   libsdl_sound for sdl2 (version 2.0.2 or higher)
-   libogg (1.2.2-1.3.0)
...
At the time of writing SDL_Sound `2.0.2` has just been released, but almost no linux distro provides it.
Until that is resolved, we recommend to download particular archive using following url:

    https://github.com/icculus/SDL_sound/releases/download/v2.0.2/SDL2_sound-2.0.2.tar.gz
